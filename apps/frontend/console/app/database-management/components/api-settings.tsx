...
import { getDatabaseSummaryAction } from "@/app/actions-with-app";
...
export default function ApiSetting() {
  ...
  const transformCarListing = async (
    ...
    for (const dataItem of dataArray) {
      ...
      const equipmentDocumentInsertResult = await db
        .collection<
          Omit<CarListingEquipmentModel, "_id">
      ...
      const sellerDocumentInsertResult = await db
        .collection<
          Omit<CarListingSellerModel, "_id">
      ...
      const messagesDocumentInsertResult = await db
        ...
        .collection<
          Omit<CarListingMessageModel, "_id">
  ...
  const transformAppUser = async (
    ...
    for (const dataItem of dataArray) {
      ...
      const notificationDocumentInsertResult = await db
        ...
        .collection<
          Omit<IAppUserNotificationModel, "_id">
      ...
      const savedSearchDocumentInsertResult = await db
        .collection<
          Omit<IAppUserSavedSearchModel, "_id">
      ...
      const businessProfileDocumentInsertResult = await db
        ...
        .collection<
          Omit<IAppUserBusinessProfileModel, "_id">
      ...
      const supportRequestDocumentInsertResult = await db
        .collection<
          Omit<IAppUserSupportRequestModel, "_id">
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      ...
      {!isConfigValid ? (
        <>
          <Card className="border-orange-200 shadow-lg bg-orange-50 dark:bg-gray-800 dark:border-orange-700">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Settings className="h-5 w-5 text-orange-600 dark:text-orange-400" />
                API Konfigürasyonu
              </CardTitle>
              <CardDescription>MAIN_APP API bağlantı ayarları</CardDescription>
            </CardHeader>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    readOnly
                    className="bg-orange-50 dark:bg-gray-700"
                  />
                </div>
