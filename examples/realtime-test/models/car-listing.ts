...
export interface CarListingNote {
  id: string;
...
export interface CarListing {
  ...
  approvedImages?: {
    category: keyof CarListing["images"]; // örn: "Interior", "Engine"
...
export interface ListingMessage {
  id: string;
  type: "inquiry" | "offer" | "system_alert" | "other"; // Mesajın türü
  sender: string; // Gönderen (örn: "Potansiyel Alıcı", "Sistem")
